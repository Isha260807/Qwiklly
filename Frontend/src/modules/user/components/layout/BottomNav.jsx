...
const BottomNav = React.memo(() => {
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto px-2 sm:px-4 py-1.5 sm:py-2 flex items-center justify-around gap-1 sm:gap-2">
        {navItems.map((item) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.94 }}
              className={`relative flex-1 max-w-[130px] flex items-center justify-center px-2 sm:px-3.5 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl transition-all duration-200 cursor-pointer select-none ${
                isActive
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-[#FCEBF3] rounded-xl sm:rounded-2xl z-0"
                  transition={{
                    type: 'spring',
                    stiffness: 400,
                    damping: 30,
              ...
              <div className="relative z-10 flex items-center justify-center gap-1.5 sm:gap-2">
                ...
                <span className={`text-xs sm:text-sm tracking-tight sm:tracking-wide whitespace-nowrap ${isActive ? 'font-extrabold' : 'font-bold'}`}>
                  {item.label}
                </span>
              </div>
            </motion.button>
