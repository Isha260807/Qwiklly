...
import { FiSearch, FiLoader, FiCalendar, FiClock, FiUser, FiShoppingBag, FiBriefcase } from 'react-icons/fi';
...
const UserBookings = () => {
  ...
  const getPartnerName = (b) => {
    return b.vendorId?.name || b.vendorId?.businessName || b.workerId?.name || 'Pending Assignment';
  };
      ...
      <CardShell icon={FiShoppingBag}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search by customer, booking ID, phone, service..."
              value={searchQuery}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-2">
                            <FiBriefcase className="w-4 h-4 text-green-500 flex-shrink-0" />
                            <span>Partner: <span className="font-medium text-gray-800">{getPartnerName(booking)}</span></span>
                          </div>
                          <div className="flex items-center gap-2">
